defmodule TodoWeb.UserLiveTest do
  ...
  @create_attrs %{status: true, description: "some description", title: "some title"}
  @update_attrs %{status: false, description: "some updated description", title: "some updated title"}
  @invalid_attrs %{status: false, description: nil, title: nil}
